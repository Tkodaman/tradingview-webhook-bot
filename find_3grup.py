...
for f in files:
    try:
        with open(f, 'r', encoding='utf-8') as file:
            for line in file:
                if 'replace_file_content' in line and ('3 grup' in line.lower() or 'market-window-crypto' in line):
                            ...
                            for tc in data['tool_calls']:
                                ...
                                if 'replace_file_content' in name:
                                    ...
                                    if 'dashboard.html' in target:
                                        ...
                                        print("FOUND 3 GRUP EDIT AT", created_at)
                                        print("REP CONTENT SAMPLE:", rep_content[:100].replace('\n', ' '))
